...
public class GuiUtil extends Gui {
    ...
    public static void renderRoundedQuad(Vec3 from, Vec3 to, int rad, Color col) {
        GL11.glPushMatrix();
        ...
        GL11.glBegin(GL11.GL_POLYGON);
        {
            ...
            double[][] map = new double[][]{
                    new double[]{to.xCoord,to.yCoord},
                    new double[]{to.xCoord,from.yCoord},
                    new double[]{from.xCoord,from.yCoord},
                    new double[]{from.xCoord,to.yCoord}
            };
            for(int i = 0;i<4;i++) {
