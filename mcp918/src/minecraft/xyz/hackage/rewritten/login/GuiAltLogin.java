package xyz.hackage.rewritten.login;
...
//    	this.drawRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), 0xff000000);
        ...
        this.drawCenteredString(this.mc.fontRendererObj, this.thread == null ? (Object)((Object)EnumChatFormatting.GRAY) + "waiting for user input" : this.thread.getStatus(), width / 2, 29, -1);
        if (this.username.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "username or e-mail", width / 2 - 96, 66, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, width / 2 - 100, var3 + 72 + 12, "attempt login"));
        this.buttonList.add(new GuiButton(1, width / 2 - 100, var3 + 72 + 12 + 24, "main menu"));
