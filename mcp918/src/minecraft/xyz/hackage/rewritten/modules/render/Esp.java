...
//			        GL11.glVertex3d(e.posX-mc.renderManager.viewerPosX-e.width, e.posY-mc.renderManager.viewerPosY+e.height, e.posZ-mc.renderManager.viewerPosZ);
			        ...
			        GL11.glVertex3d(e.lastTickPosX -0.5+ (e.posX - e.lastTickPosX) * ((EventRender)ev).partialTicks  - mc.renderManager.viewerPosX, e.lastTickPosY + (e.posY - e.lastTickPosY) * ((EventRender)ev).partialTicks  - mc.renderManager.viewerPosY + e.height, e.lastTickPosZ + (e.posZ - e.lastTickPosZ) * ((EventRender)ev).partialTicks  - mc.renderManager.viewerPosZ);
			        GL11.glVertex3d(e.lastTickPosX +0.5+ (e.posX - e.lastTickPosX) * ((EventRender)ev).partialTicks  - mc.renderManager.viewerPosX, e.lastTickPosY + (e.posY - e.lastTickPosY) * ((EventRender)ev).partialTicks  - mc.renderManager.viewerPosY + e.height, e.lastTickPosZ + (e.posZ - e.lastTickPosZ) * ((EventRender)ev).partialTicks  - mc.renderManager.viewerPosZ);
