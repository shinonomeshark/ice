...
//            j1 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s1, (float)l, (float)i1, i);
         ...
         if(s.length() > 0 && flag && j < s.length()) {
            j1 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
         }
         ...
         if(flag1) {
            if(flag2) {
               ...
               Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("_", (float)k1, (float)i1, i);
            }
         }
