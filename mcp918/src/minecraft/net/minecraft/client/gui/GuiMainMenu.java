...
//      Client.bpufr.drawCenteredString("pine", this.width/2, this.height/15.3f, 0xff000000);
//      Gui.drawModalRectWithCustomSizedTexture((this.width/2)+32, this.height/15.3f, (this.width/2)+32, this.height/15.3f, this.width/2, this.height/15.3f, 32, 32);
      
      this.mc.getTextureManager().bindTexture(new ResourceLocation("hackage/icons/pine.png"));
      this.drawTexturedModalRect(j + 0, k + 0, 0, 0, 99, 44);
      
      Client.ufr.drawString(s, 2, this.height - 14, 0xff000000);
      String s1 = Client.VERSION;
      Client.ufr.drawString(s1, this.width - Client.ufr.getStringWidth(s1) - 4, this.height - 14, 0xff000000);
