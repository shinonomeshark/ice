...
public abstract class GuiContainer extends GuiScreen {
   ...
   private SystemTimerUtil tim = new SystemTimerUtil(); //tim 2 electric boogaloo
   // how are you tim
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
	  ...
	  double animTing = AnimationUtil.easeOutExpo(animTime/700d);
	  GlStateManager.translate(0, -100, 0);
	  GlStateManager.translate(0, 100*animTing, 0);
